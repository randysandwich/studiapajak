...
new Vue({
	...
	data: {
		...
		linkdrip: {
			skin: "SKIN_NAME",
			profile: {
				image: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxjb2xsZWN0aW9uLXBhZ2V8MXw3NjA4Mjc3NHx8ZW58MHx8fHw%3D&w=1000&q=80", //"https://smhlancers.org/wp-content/uploads/2016/06/profile-placeholder-300x300.png",
				name: {
					text: "webbendr"
				},
				description: {
